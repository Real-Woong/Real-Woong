...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=58A6FF&center=true&width=650&lines=CS+Student+at+Yonsei+University;AI+%2B+System+Builder;Web+%2B+AI+%2B+Blockchain+Projects)](https://git.io/typing-svg)
...
| [Textro](https://github.com/Real-Woong/textro) | Tesseract OCR-based PDF text extraction tool |
| [BlockTroll](https://github.com/Real-Woong/blocktroll) | AI toxic comment filtering extension |
...
- BubbleBreak 2.0 — realtime WebSocket matching system
- AI-SPOC — NLP routing system for civil complaints
- BlockTroll — AI comment moderation tool

---

# 🐍 Contribution Snake

![snake gif](https://github.com/Real-Woong/Real-Woong/blob/output/github-contribution-grid-snake.svg)
